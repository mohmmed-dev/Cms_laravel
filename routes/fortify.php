...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
    ...
    // Authentication...
    if ($enableViews) {
        Route::get(RoutePath::for('login', '/sigin'), [AuthenticatedSessionController::class, 'create'])
    ...
    Route::post(RoutePath::for('login', '/sigin'), [AuthenticatedSessionController::class, 'store'])
